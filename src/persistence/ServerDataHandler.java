    ...
    public void insert(Object changedObject){
        ...
        switch(table){
            ...
            case "Meeting":
                ...
                mySQLQuery.insert("MeetingInvite", new ArrayList<>(Arrays.asList("meetingID", "username")), new ArrayList<>(Arrays.asList(String.valueOf(meeting.getMeetingID()), meeting.getCreator(), "true")));
                break;
            case "ExternalUser":
