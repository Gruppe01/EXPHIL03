    ...
    public void insert(Object changedObject){
        ...
        switch(table){
            ...
            case "Meeting":
                ...
                mySQLQuery.insert("MeetingInvite", new ArrayList<>(Arrays.asList("meetingID", "username", "coming")), new ArrayList<>(Arrays.asList(String.valueOf(meeting.getMeetingID()), meeting.getCreator(), "")));
                break;
            case "ExternalUser":
